...
public class EstadisticasDTO {
    ...
    public EstadisticasDTO(Player player, double points, double asists, double rebounds, double steals, double blocks, double fieldgoalsattempted, double fieldgoalsmade, double threepointattempted, double threepointmade, double freethrowsattempted, double freethrowsmade) {
        this.player = player;
        this.points = points;
        this.asists = asists;
